...
if !hasmapto('<Plug>CRV_CRefVimVisual')
    vmap <silent> <unique> <Leader>rc <Plug>CRV_CRefVimVisual
endif
if !hasmapto('<Plug>CRV_CRefVimNormal')
    nmap <silent> <unique> <Leader>rc <Plug>CRV_CRefVimNormal
endif
if !hasmapto('<Plug>CRV_CRefVimAsk')
    map <silent> <unique> <Leader>rcw <Plug>CRV_CRefVimAsk
endif
if !hasmapto('<Plug>CRV_CRefVimInvoke')
    map <silent> <unique> <Leader>rcc <Plug>CRV_CRefVimInvoke
endif
