...
if !hasmapto('<Plug>StlRefVimVisual')
    vmap <silent> <unique> <Leader>rt <Plug>StlRefVimVisual
endif
if !hasmapto('<Plug>StlRefVimNormal')
    nmap <silent> <unique> <Leader>rt <Plug>StlRefVimNormal
endif
if !hasmapto('<Plug>StlRefVimAsk')
    map <silent> <unique> <Leader>rtw <Plug>StlRefVimAsk
endif
if !hasmapto('<Plug>StlRefVimInvoke')
    map <silent> <unique> <Leader>rtc <Plug>StlRefVimInvoke
endif
if !hasmapto('<Plug>StlRefVimExample')
    map <silent> <unique> <Leader>rte <Plug>StlRefVimExample
endif
